...
var DecisionGraph = function (epsilonSymbol) {
   ...
   * @returns {string} the string representing epsilon
   */
 ...
 * @see {@link GuidedDecisionGraph}
 */
DecisionGraph.prototype.guide = function (start) {
  return new GuidedDecisionGraph(this, start)
}
